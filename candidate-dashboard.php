...
<!-- Mirrored from creativelayers.net/themes/superio/candidate-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Sep 2023 18:14:24 GMT -->

<!-- Mirrored from workman1.cdott.com/candidate-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Sep 2023 11:34:06 GMT -->
<head>
...
<body>
  ...
  <script>
    $(document).ready(function() {
        $.ajax({
            url: 'function/job-seeker/get_counts.php',
            type: 'GET',
            dataType: 'json',
            success: function(data) {
                $('#appliedJobCount').html('<h4>' + data.applied_job_count + '</h4><p>Applied Jobs</p>');
            },
            error: function() {
...
<script>
        ...
        function fetchDataAndUpdateChart(selectedRange, labels) {
            ...
            $.ajax({
                url: 'function/job-seeker/get_spv_count.php', // Change to the correct URL
                type: 'GET',
...
<!-- Mirrored from creativelayers.net/themes/superio/candidate-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Sep 2023 18:14:26 GMT -->

<!-- Mirrored from workman1.cdott.com/candidate-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Sep 2023 11:35:04 GMT -->
</html>