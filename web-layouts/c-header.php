        ...
        <div class="main-box">
          ...
          <div class="outer-box">
            ...
            <div class="dropdown dashboard-option">
              ...
              <img src="<?php echo $url; ?>function/job-seeker/uploads/profile/<?php echo $_SESSION["profile_image_path"]; ?>" style="object-fit: cover;" alt="avatar" class="thumb">
                <span class="name">My Account</span>
              </a>
              <ul class="dropdown-menu">
                <li><a href="<?php echo $url;?>candidates-resume-view.php"><i class="la la-user-alt"></i>View Profile</a></li>
