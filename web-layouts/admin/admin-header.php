<header class="main-header header-shaddow">
      <div class="container-fluid">
        ...
        <div class="main-box">
          ...
          <div class="nav-outer">
            <div class="logo-box">
              <div class="logo"><a href="index.php"><img src="<?php echo $url;?>images/logo.svg" alt="" title=""></a></div>
            </div>
          ...
          <div class="outer-box">
            ...
            <div class="dropdown dashboard-option">
              <a class="dropdown-toggle" role="button" data-toggle="dropdown" aria-expanded="false">
                <img src="<?php echo $url;?>images/resource/company-6.png" alt="avatar" class="thumb">
                <span class="name">My Account</span>
              </a>
              <ul class="dropdown-menu">
                <li><a href="#"><i class="la la-user-alt"></i>View Profile</a></li>
                <li><a href="<?php echo $url;?>admin-logout.php"><i class="la la-sign-out"></i>Logout</a></li>
              </ul>
            </div>
          </div>
        </div>
