...
<body>
  ...
  <script>
    $(document).ready(function() {
      var js_id = <?php echo isset($js_id) ? json_encode($js_id) : 'null'; ?>;
    ...
    function fetchEducationData() {
      $.ajax({
        ...
        success: function (data) {
          // Clear the existing content in the education container
          ...
          for (var i = 0; i < data.length; i++) {
            ...
            // Append the education item to the container div with id "educationContainer"
...
<script>
  $(document).ready(function () {
    // Function to fetch and display award data
    var js_id = <?php echo isset($js_id) ? json_encode($js_id) : 'null'; ?>;
    console.log("js_id:", js_id);
    function fetchAwardData() {
      $.ajax({
        ...
        data: { js_id: js_id }, 
        success: function (data) {
          // Clear the existing content in the award container
          console.log("Received data:", data); // Log received data
          $("#awardContainer").empty();
          ...
          for (var i = 0; i < data.length; i++) {
            ...
            // Append the award item to the container div with id "awardContainer"
    ...
    // Call the function to fetch and display award data
    fetchAwardData();
  });
</script>
